...
import { updateNote } from "../../features/notesList/notesListSlice";
  ...
  return (
    <>
      ...
      <Card style={{ backgroundColor: color }}>
            ...
            {type !== "archive" && type !== "trash" && (
              <NotesIconBox
                ...
                onClick={() => {
                  ...
                  setTimeout(() => dispatch(updateNote({...note, isPinned: !note.isPinned})), 1000)
                }}
              >
                <BsFillPinFill
        ...
        <FooterBox>
          <div className="noteCard__date">{note.eventDate}</div>
