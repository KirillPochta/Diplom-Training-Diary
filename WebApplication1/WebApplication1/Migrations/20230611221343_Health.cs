        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MusicSrc = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Birth", "Country", "Email", "FavMusic", "FirstName", "Gender", "Image", "Interests", "Joined", "LastName", "Password", "RoleId" },
                values: new object[] { new Guid("da21c8d2-7cef-4c85-8108-a07bc4ad419d"), new DateTime(2001, 6, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "admin@gmail.com", null, "admin", "Female", null, "I love doing push ups", new DateTime(2023, 6, 12, 1, 13, 41, 850, DateTimeKind.Local).AddTicks(7426), "admin", "$2a$12$uCdrOY2Rmmh5xH6Pz/YNXOPsTMzAI9BiHw6aQro.K/d/YggAJ7B4e", 1 });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Birth", "Country", "Email", "FavMusic", "FirstName", "Gender", "Image", "Interests", "Joined", "LastName", "Password", "RoleId" },
                values: new object[] { new Guid("536bc8fe-d271-4ae4-ac7d-5241d83974d9"), new DateTime(2001, 6, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "pochta@gmail.com", null, "Kira", "Male", null, "I am fat guy :(", new DateTime(2023, 6, 12, 1, 13, 41, 850, DateTimeKind.Local).AddTicks(2111), "Kira", "$2a$12$oPwFcsM8GdQId4Dk1/0WSOaCFPegd0i6Z2mR.E6cG4Zn2OUUyMDpa", 2 });

            migrationBuilder.InsertData(
                table: "Notes",
                columns: new[] { "Id", "Body", "Date", "EventDate", "IsPinned", "Name", "Priority", "UserId", "color" },
                values: new object[,]
                {
                    { new Guid("7545c85f-1238-43df-bdd4-2ca2f62003e2"), "Иногда мне сниться сыр, он такой вкусный", null, null, false, "Сегодня мне снился сыр", "LOW", new Guid("536bc8fe-d271-4ae4-ac7d-5241d83974d9"), null },
                    { new Guid("5b6f9eb1-eb1a-42fd-a10c-c5182fcfbd1b"), "Запись у невролога в пятницу", null, null, false, "Надо бы сходить к врачу", "HIGH", new Guid("536bc8fe-d271-4ae4-ac7d-5241d83974d9"), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0cbe525e-09de-4d95-8260-fb8e38d12322"), "Тренировки 3-5 раза в неделю", 27, 41, 0, 0, 0, 0, 0, "Набрать мышечную массу", 165, 45, "Предожирение", new Guid("da21c8d2-7cef-4c85-8108-a07bc4ad419d"), 50, 74 },
                    { new Guid("7f87a6de-0fa3-4958-8a31-074a2b4cb03c"), "Тренировки 1-3 раза в неделю", 27, 41, 0, 0, 0, 0, 0, "Похудение", 165, 45, "Предожирение", new Guid("536bc8fe-d271-4ae4-ac7d-5241d83974d9"), 50, 74 }
                });

            migrationBuilder.InsertData(
                table: "TagsNote",
                columns: new[] { "Id", "NoteId", "TagId" },
                values: new object[] { new Guid("8d0800b4-6ac9-4664-8dcc-45e4736d5dd1"), new Guid("7545c85f-1238-43df-bdd4-2ca2f62003e2"), new Guid("ecd8cdc5-db46-44ec-aadc-291946310cb4") });

            migrationBuilder.InsertData(
                table: "TagsNote",
                columns: new[] { "Id", "NoteId", "TagId" },
                values: new object[] { new Guid("fac5222d-d268-4388-83cd-4cf5a35560fd"), new Guid("5b6f9eb1-eb1a-42fd-a10c-c5182fcfbd1b"), new Guid("0862a850-20d5-44d0-b3d9-876790c99b84") });

            migrationBuilder.InsertData(
                table: "TagsNote",
                columns: new[] { "Id", "NoteId", "TagId" },
                values: new object[] { new Guid("ed80a509-f160-4d80-8b5a-1c30149236a3"), new Guid("5b6f9eb1-eb1a-42fd-a10c-c5182fcfbd1b"), new Guid("7b36766c-5e19-44ab-93b0-f3f0d39997d4") });
